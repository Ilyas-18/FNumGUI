...
public class GUI_Rahmen_10 extends javax.swing.JFrame {
    ...
    private Font f1 = new Font("Kefa", Font.BOLD, 20);
        ...
        public static void main(String[] args) {
            GUI_10.GUI_Rahmen_10 frame = new GUI_10.GUI_Rahmen_10();
            frame.setPreferredSize(new Dimension(600,500));
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.pack();
            frame.setVisible(true);
            frame.setContentPane(new GUI_10.GUI_Rahmen_10().panelMain);
        }
